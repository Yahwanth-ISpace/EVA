# 🦷 ClaimBot: AI-Powered Dental Insurance Verification System

ClaimBot is a monorepo that automates the process of verifying dental insurance coverage using voice calls and AI. The system transcribes phone call audio, extracts insurance details using an LLM (e.g., Mistral via Ollama), and stores the results for each patient.
...
Use the provided `ClaimBot.postman_collection.json` file to test all endpoints including:
